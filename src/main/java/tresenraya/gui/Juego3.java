...
public class Juego3 {
    ...
    /*public int create(Modelotresenraya d) {
        int rsId=0;
        String[] returns={"resultado"};
        String sql="INSERT INTO resultados(nombre_partida, nombre_jugador1, nombre_jugador2, ganador, estado"
                +"punto")" + "values(?,?,?,?,?,?);"; 
        int i=0;           
    }*/
